...
import { RoadNetworkEditorPage } from './components/RoadNetworkEditorPage';
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/projects/:projectId/maps/:mapId/edit" element={<ProtectedRoute><RoadNetworkEditorPage /></ProtectedRoute>} />
